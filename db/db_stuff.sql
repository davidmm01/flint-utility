CREATE TABLE 'bye_round' ('br_id' INTEGER PRIMARY KEY AUTOINCREMENT, 'br_round' INTEGER NOT NULL, 'br_year' INTEGER NOT NULL);
...
CREATE TABLE `lineup_settings` (`ls_year` INTEGER NOT NULL PRIMARY KEY,`ls_backs` INTEGER DEFAULT NULL,`ls_centres` INTEGER DEFAULT NULL,`ls_rucks` INTEGER DEFAULT NULL,`ls_forwards` INTEGER DEFAULT NULL,`ls_utilities` INTEGER DEFAULT NULL,`ls_backs_em` INTEGER DEFAULT NULL,`ls_centres_em` INTEGER DEFAULT NULL,`ls_rucks_em` INTEGER DEFAULT NULL,`ls_forwards_em` INTEGER DEFAULT NULL,`ls_utilities_em` INTEGER DEFAULT NULL,`ls_bench` INTEGER DEFAULT NULL);
...
CREATE TABLE 'coach' ('c_coach_id' VARCHAR(20) PRIMARY KEY, 'c_real_name' VARCHAR(200) NOT NULL);
...
CREATE TABLE 'coach_season' ('cs_id' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, 'cs_coach' VARCHAR(20) NOT NULL, 'season' INTEGER NOT NULL, FOREIGN KEY(`cs_coach`) REFERENCES coach(`c_coach_id`));
...
CREATE TABLE `round_matchup` (`rm_id` INTEGER PRIMARY KEY AUTOINCREMENT, `rm_round` INTEGER NOT NULL, `rm_year` INTEGER DEFAULT NULL, `rm_c_coach_id_1` varchar(20) DEFAULT NULL, `rm_c_coach_id_2` varchar(20) DEFAULT NULL, FOREIGN KEY(`rm_c_coach_id_1`) REFERENCES coach(`c_coach_id`), FOREIGN KEY(`rm_c_coach_id_2`) REFERENCES coach(`c_coach_id`));

CREATE TABLE `round_score` (
  `rs_id` INTEGER PRIMARY KEY AUTOINCREMENT,
  `rs_round` INTEGER NOT NULL,
  `rs_year` INTEGER DEFAULT NULL,
  `rs_c_coach_id` varchar(20) DEFAULT NULL,
...
CREATE TABLE `player_score` (
  ...
  `ps_round` int DEFAULT NULL,
  `ps_year` int DEFAULT NULL,
  `ps_c_coach_id` varchar(20) DEFAULT NULL,
  `ps_player` VARCHAR(200) NOT NULL,
  `ps_score` int DEFAULT NULL,
  `ps_kicks` int DEFAULT NULL,
  `ps_handballs` int DEFAULT NULL,
  `ps_marks` int DEFAULT NULL,
  `ps_hitouts` int DEFAULT NULL,
  `ps_tackles` int DEFAULT NULL,
  `ps_disposal_efficiency` float(7,6) DEFAULT NULL,
  `ps_contested_posessions` int DEFAULT NULL,
  `ps_rebound_50s` int DEFAULT NULL,
  `ps_clearances` int DEFAULT NULL,
  `ps_spoils` int DEFAULT NULL,
  `ps_real_value` int DEFAULT NULL,
