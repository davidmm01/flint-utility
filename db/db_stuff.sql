...
CREATE TABLE `round_matchup` (`rm_id` INTEGER PRIMARY KEY AUTOINCREMENT, `rm_year` INTEGER NOT NULL, `rm_round` INTEGER NOT NULL, `rm_game` INTEGER NOT NULL,`rm_c_coach_id_1` varchar(20) NOT NULL, `rm_c_coach_id_2` varchar(20) NOT NULL, FOREIGN KEY(`rm_c_coach_id_1`) REFERENCES coach(`c_coach_id`), FOREIGN KEY(`rm_c_coach_id_2`) REFERENCES coach(`c_coach_id`));
